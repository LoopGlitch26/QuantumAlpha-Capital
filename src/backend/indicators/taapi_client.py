...
class TAAPIClient:
    ...
    def fetch_series(self, indicator: str, symbol: str, interval: str, results: int = 10, params: Optional[dict] = None, value_key: str = "value") -> list:
    ...
    def fetch_value(self, indicator: str, symbol: str, interval: str, params: Optional[dict] = None, key: str = "value"):
