...
class HyperliquidAPI:
    ...
    def __init__(self):
        ...
        # For Hyperliquid API wallets: use separate account address for balance queries
        self.account_address = CONFIG.get("hyperliquid_account_address") or self.wallet.address
        logging.info(f"Trading wallet: {self.wallet.address}")
        logging.info(f"Account address (for balance): {self.account_address}")
